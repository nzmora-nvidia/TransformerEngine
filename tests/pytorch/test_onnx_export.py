...
def test_kvcache_mha(
    ...
    outp_seq_len = 4 # generation phase: output sequence length (the first output token is generated by the context)
    max_seq_len = inp_seq_len + outp_seq_len
    nb_generations = outp_seq_len - 1
    ...
    class TestFP8_KVCacheMHA(nn.Module):
        def __init__(self, nb_layers, max_seq_len):
            super().__init__()
    ...
    model = TestFP8_KVCacheMHA(nb_layers=2, max_seq_len=max_seq_len)
